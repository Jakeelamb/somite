...
const cases: FullPaperCase[] = [
  { path: "pdf/love_f1000.pdf", outcome: "drafts_ready", assays: ["rna_seq"], required: ["align.star", "quant.featurecounts", "diff.deseq2"], forbidden: ["nf.rnaseq"], unsupported: [] },
  ...
  { path: "pdf/rhie_vgp.pdf", outcome: "drafts_ready", assays: ["assembly"], required: ["qc.busco"], forbidden: ["nf.rnaseq"], unsupported: ["falcon", "purgedups", "salsa"] },
